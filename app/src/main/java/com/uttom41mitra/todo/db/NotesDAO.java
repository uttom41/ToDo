...
public class NotesDAO {
    ...
    public boolean AddNotes(ModelValue model){
        this.open();
        ...
        long id =   sqLiteDatabase.insert(NOTES_TABLE,null,values);
    ...
    public boolean DeleteDaily(int ibd){
        this.open();
        int delete=  sqLiteDatabase.delete(NOTES_TABLE,COL_ID +"=?",new String[] {Integer.toString(ibd)} );
