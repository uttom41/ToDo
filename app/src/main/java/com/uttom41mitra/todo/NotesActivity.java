...
public class NotesActivity extends AppCompatActivity implements OnClickEvent {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        notesRv = findViewById(R.id.dailyRV);
        ...
        addBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                final Dialog dialog = new Dialog(NotesActivity.this, R.style.DialogThemeTwo);
                ...
                saveBtn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if (!TextUtils.isEmpty(text)){
                            ...
                            boolean status = notesDAO.AddNotes(modelValue);
                            if (status) {
                                ...
                                Toast.makeText(NotesActivity.this, "fail", Toast.LENGTH_SHORT).show();
                        }else {
    ...
    private void Showdaily() {
        ArrayList<ModelValue> dailyList = notesDAO.GetAllValue();
        if (dailyList.size()>0){
            ...
            notesRv.setLayoutManager(new GridLayoutManager(this, 1, VERTICAL, false));
        }else {
            DailyAdapter adapter = new DailyAdapter(this, dailyList,this::ClickEvent);
            notesRv.setAdapter(adapter);
            adapter.notifyDataSetChanged();
    ...
    public void ClickEvent(int position) {
        boolean status = notesDAO.DeleteDaily(position);
        if (status)
            Showdaily();
